...
def load_data(train=True, data_dir='dataset/imagenet', batch_size=128, subset_len=None, sample_method='random', distributed=False, model_name='resnet20', **kwargs):
  #prepare data
  # random.seed(12345)
  ...
  """if model_name == 'inception_v3':
    ...
    size = 224
    resize = 256""" #These aren't needed in our case
  if train:
...
def quantization(title='optimize', model_name='', file_path=''):
  ...
  #Only change the shape of your data here, leave the values random.
